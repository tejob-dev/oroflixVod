...
class UserAccountController extends Controller
{
    ...
    public function get_payment(Request $request, $id)
    {
        ...
        return view('subscribe', compact('plan','stripe_payment', 'currency_payments', 'bankdetails', 'account_no', 'account_name', 'ifsc_code', 'bank', 'razorpay_payment', 'intent', 'instamojo_payment', 'mollie_payment', 'cashfree_payment', 'omise_payment', 'flutterrave_payment', 'manualpaymentmethod', 'coin_payment', 'payhere_payment','worldpay_payment','squarepay_payment'));
    }
