...
class HomeController extends Controller
{
    ...
    public function guestindex(Request $request, $menu_slug)
    {
        ...
        $menuIds = $menu->id;
        $banner = BannerAdd::whereHas('banneradd_menu', function ($query) use ($menuIds) {
        $query->where('menu_id', $menuIds);
        })
        ->get();
        ...
        if ($this->configs->prime_genre_slider == 1) {
            //Layout 1
            return view('home', compact('request','getallgenre','protip', 'menu_data', 'recent_data', 'ad', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed', 'audiolanguages', 'section6', 'blogs', 'liveevent', 'home_slides', 'age', 'audio', 'short_promo', 'audio_lang', 'upcomingitems', 'getallaudiolanguage', 'top_data','banner'));
        } else {
            //Layout 2
            return view('home2', compact('request','getallgenre','protip', 'menu_data', 'recent_data', 'ad', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed', 'audiolanguages', 'section6', 'blogs', 'liveevent', 'home_slides', 'age', 'audio', 'short_promo', 'audio_lang', 'upcomingitems', 'getallaudiolanguage', 'top_data','banner'));
        }
    ...
    public function index(Request $request, $menu_slug)
    {
        ...
        elseif ($this->configs->prime_genre_slider == 1) {
            //Layout 1
            //return $usercountry;
            return view('home', compact('request','menu_data', 'recent_data', 'home_slides', 'ad', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed', 'watchistory', 'audiolanguages',  'getallgenre', 'blogs', 'liveevent', 'protip', 'audio', 'short_promo', 'audio_lang', 'upcomingitems', 'getallaudiolanguage', 'top_data','banner'));
        } else {
            //Layout 2
            return view('home2', compact('request','menu_data', 'recent_data', 'home_slides', 'ad', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed', 'watchistory', 'audiolanguages',  'getallgenre', 'blogs', 'liveevent', 'protip', 'audio', 'short_promo', 'audio_lang', 'upcomingitems', 'getallaudiolanguage', 'top_data','banner'));
        }
    ...
    {
        //return ($request);
        $plans = Package::orderBy('id', 'asc')->get();
