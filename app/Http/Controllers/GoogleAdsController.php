...
class GoogleAdsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('google.ads')->with('success', __('Google Ad Created Successfully !'));
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('google.ads')->with('success', __('GoogleAds Update Successfully!'));
        } catch (\Exception $e) {
            return back()->with('deleted', $e->getMessage());
