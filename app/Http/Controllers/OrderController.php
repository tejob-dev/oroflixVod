...
class OrderController extends Controller
{
    ...
    public function purchasehistory()
    {
         ...
         if(Auth::check())
        {
            ...
            return view('quedecato.front.purchase_history.purchase',compact('orders', 'course', 'refunds'));
    ...
    public function invoice($id)
    {
        ...
        return view('quedecato.front.purchase_history.invoice', compact('orders', 'course', 'Bundle', 'bundle_order', 'invoice'));
