...
class AppSliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'slide_image' => 'required|file|image|mimes:png,jpeg,jpg,gif,webp',
        ]);
        ...
        return back()->with('success', 'App Slide has been added');
    ...
    public function update(Request $request, $id)
    {
        ...
        $slide->update($input);
        return redirect('admin/appslider')->with('success', __('App Slide has been updated'));
    }
