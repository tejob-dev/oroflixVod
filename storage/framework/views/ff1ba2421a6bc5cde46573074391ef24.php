          ...
          <div class="panel-setting-main-block panel-subscribe">
            <div class="container-fluid">
              <div class="plan-block-dtl">
                <h3 class="plan-dtl-heading text-center"><?php echo e(__('Purchase any of the membership package from below.')); ?></h3>
                <div class="plan-dtl-list">
                  
                  <ul>
                    <li><?php echo e(__('Select in of your preferred membership package & make payment.')); ?>
              ...
              <?php if(Auth::check()): ?>
                <?php  
                  $id = Auth::user()->id;
                  $getuserplan = App\PaypalSubscription::where('status','=','1')->where('user_id',$id)->orderBy('id','ASC')->first();
                ...
                <?php if($plan->delete_status ==1 ): ?>
                  <?php if($plan->status != 'inactive'): ?>
                    <div class="col-lg-3 col-sm-6">
                      ...
                      $features = App\Package::where('id',$plan->id)->get();
                      $planFeatures = $plan['feature'];
                      // Retrieve the features based on their IDs
                      ...
                      <?php if(isset($features)): ?>                        
                        <ul class="plan-features">
                          <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <i class="fa fa-check"></i> <?php echo e($feature); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\NexthourWeb\resources\views/main.blade.php ENDPATH**/ ?>