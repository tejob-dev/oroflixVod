...
<head>
  ...
  <?php if($color->color_scheme == 'dark'): ?>
    ...
    :root {
      ...
      --background_color: <?php echo e($color->custom_text_color != NULL ? $color->custom_text_color : $color->default_text_color); ?>;
              ...
              <ul>
                  ...
                  <?php if($button->kids_mode==1): ?>
                      ...
                      <li style="width:13%;padding: 0px">
                          <a href="<?php echo e(route('get.kids', Auth::user()->id)); ?>"
                              style="background-image: url(<?php echo e(asset('images/kids.png')); ?>);background-repeat: no-repeat;background-size: contain;margin: 0px 12px;padding: 15px 7px !important;"></a>
                      </li>
                      <?php endif; ?>
                  <?php endif; ?>
              <?php else: ?>
              ...
              <?php if(isset($lang) && count($lang) > 1): ?>
                ...
                <li class="sign-in-block language-switch-block">
                  <div class="dropdown prime-dropdown">
                    ...
                    <div class="dropdown-menu prime-dropdown-menu">
                      <div>
                        <ul>
                          ...
                          <div class="admin-wallet-block">
                            <ul>
                              <li><img src="<?php echo e(url('/images/walletnew.png')); ?>" class="img-fluid" alt="">
                                <span class="wallet-title"><?php echo e(__('Wallet Balance')); ?></span>
                              </li>
                              <li>
                                <span>
                      ...
                      <!-- <div class="col-sm-6 col-lg-6"> -->
                        <div>
                          <ul class="admin-list">
                            ...
                            <li><a href="<?php echo e(url('admin')); ?>" target="_blank"><img src="<?php echo e(url('images/user_dropdown/globe.png')); ?>" class="img-fluid" alt=""><?php echo e(auth()->user()->getRoleNames()[0]); ?>

                                <?php echo e(__('Dashboard')); ?></a></li>
                            <?php endif; ?>
                            <?php if($auth->is_assistant == 1): ?>
                            <li>
                              <a href="<?php echo e(url('admin')); ?>" target="_blank"><img src="<?php echo e(url('images/user_dropdown/globe.png')); ?>" class="img-fluid" alt="">
                                <?php echo e(__('Producer Dashboard')); ?></a>
                            </li>
                            <?php endif; ?>
                            <li><a href="<?php echo e(url('account')); ?>"><img src="<?php echo e(url('images/user_dropdown/pie-chart.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Dashboard')); ?></a></li>
                            <?php if(Module::find('Producer') && Module::find('Producer')->isEnabled()): ?>
                            <?php if($auth->is_admin != 1): ?>
                            <?php if($button->producer_approval==1 && $auth->producer_status == 0): ?>
                            <li><a href="" data-toggle="modal" data-target="#myModalproducer"><img src="<?php echo e(url('images/user_dropdown/producer.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Become An Producer')); ?></a></li>
                            <?php else: ?>
                            <li><a href="<?php echo e(url('producer/subscription')); ?>"><img src="<?php echo e(url('images/user_dropdown/subscription.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Producer Subscription Plans')); ?></a></li>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php endif; ?>
                           <?php 
                            $movies = App\Movie::where('is_protect', 1)->where('password', '!=', null)->get();
                            $seasons = App\Season::where('is_protect', 1)->where('password', '!=', null)->get();
                            $audio = App\Audio::where('is_protect', 1)->where('password', '!=', null)->get();
                        ?>

                        <?php if(getSubscription()->getData()->subscribed == true && ($movies->count() > 0 || $seasons->count() > 0 || $audio->count() > 0)): ?>
                            <li><a href="<?php echo e(route('protectedvideo')); ?>"><img src="<?php echo e(url('images/user_dropdown/shield.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Protected Content')); ?></a></li>

                            <?php else: ?>
                            <li><a href="<?php echo e(url('account/purchaseplan')); ?>"><img src="<?php echo e(url('images/user_dropdown/subscribe.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Subscribe')); ?></a></li>
                            <?php endif; ?> 
                            <?php 
                             $ebooks = App\Ebook::all();

                            ?>
                            <?php if($auth && getSubscription()->getData()->subscribed == true && count($ebooks) > 0): ?>
                            <li><a href="<?php echo e(url('account/ebook')); ?>"><img src="<?php echo e(url('images/user_dropdown/blog.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Ebooks')); ?></a></li>
                            <?php endif; ?>
                            <?php if(auth()->user()->is_admin == 0): ?>
                            <li>
                              <a data-toggle="modal" data-target="#exampleModal">
                                <img src="<?php echo e(url('images/user_dropdown/request.png')); ?>" class="img-fluid" alt="">Delete Account Request
                              </a>
                          </li>
                            ...
                            <li><a href="" data-toggle="modal" data-target="#myModalmovierequest"><img src="<?php echo e(url('images/user_dropdown/request.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Request a Movie')); ?></a></li>
                            <?php endif; ?>
                            <?php if($auth && getSubscription()->getData()->subscribed == true && $configs->blog==1): ?>
                            <li><a href="<?php echo e(url('account/blog')); ?>"><img src="<?php echo e(url('images/user_dropdown/blog.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Blog')); ?></a></li>
                            <?php endif; ?>
                            <li><a href="<?php echo e(url('faq')); ?>"><img src="<?php echo e(url('images/user_dropdown/help.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Faq')); ?></a></li>
                            ...
                            <li><a
                                href="<?php echo e(url('/manageprofile/mus/'.Auth::user()->id)); ?>"><img src="<?php echo e(url('images/user_dropdown/user-profile.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Manage Profile')); ?></a>
                            </li>
                            <?php endif; ?>
                            <?php
                            ...
                            <li><a target="_blank" href="<?php echo e($donation_link); ?>"><img src="<?php echo e(url('images/user_dropdown/donation.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Donation')); ?></a></li>
                            <?php endif; ?>

                            <?php if(isset($button) && $button->two_factor == 1): ?>
                            <li><a href="<?php echo e(route('2fa.get')); ?>"><img src="<?php echo e(url('images/user_dropdown/authenticity.png')); ?>" class="img-fluid" alt=""><?php echo e(__('2Factor Authentication')); ?></a></li>
                            <?php endif; ?>
                            <?php
                              $nav=App\Menu::orderBy('position','ASC')->get();
                              $watchlist = App\Wishlist::where('user_id',Auth::user()->id)->get();
                              $watchhistory = App\WatchHistory::where('user_id',Auth::user()->id)->get();
                            ?>
                           <?php if(isset($watchlist) && count($watchhistory) > 0): ?>

                            <li><a href="<?php echo e(route('watchhistory')); ?>"><img src="<?php echo e(url('images/user_dropdown/history.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Watch History')); ?> </a> </li>
                            <li><a href="<?php echo e(route('hidden.videos')); ?>"><img src="<?php echo e(url('images/user_dropdown/hide.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Hidden Videos')); ?> </a> </li>
                            <?php endif; ?>
                            <?php if(isset($watchlist) && count($watchlist) > 0): ?>
                            <li><a href="<?php echo e(url('account/watchlist', $nav[0]->slug ?? '')); ?>"><img src="<?php echo e(url('images/user_dropdown/bookmark.png')); ?>" class="img-fluid" alt=""><?php echo e(__('Watch list')); ?> </a> </li>
                            <?php endif; ?>
                            <li>
                              <a href="<?php echo e(route('custom.logout')); ?>"><img src="<?php echo e(url('images/user_dropdown/log-out.png')); ?>" class="img-fluid" alt="">
  ...
  <div class="small-screen-navigation">
    <nav class="sidenav" id="mySidenav" role="navigation">
        ...
        <ul class="nav sidebar-nav">
            <?php if($catlog==1): ?>
            <?php if(auth()->guard()->check()): ?>
            <?php if((isset($menuh) || isset($custom_page)) && Auth::user()->kids_mode_active == 0): ?>
            <?php if(isset($menuh) && count($menuh) > 0): ?>
            <?php $__currentLoopData = $menuh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($auth && getSubscription()->getData()->subscribed == true): ?>
            <li>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            <?php if($button->kids_mode==1 && Auth::user() && $auth != NULL && getSubscription()->getData()->subscribed == true): ?>
            <li style="width:13%;padding: 0px">
            ...
            <?php endif; ?>
            <?php else: ?>
            <li class="sign-in-block sign-in-block-one sign-in-block-two"><a class="sign-in" href="<?php echo e(url('login')); ?>"><i class="flaticon-login"></i> <?php echo e(__('Sign-in')); ?></a></li>
            <li class="sign-in-block sign-in-block-one "><a class="sign-in" href="<?php echo e(url('register')); ?>"><i class="flaticon-profile"></i><?php echo e(__('Register')); ?></a></li>
            <?php endif; ?>
        </ul>
    </nav>
...
</html><?php /**PATH C:\laragon\www\NexthourWeb\resources\views/layouts/theme.blade.php ENDPATH**/ ?>