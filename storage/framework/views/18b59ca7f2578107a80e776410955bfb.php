...
<div class="contentbar">
  ...
  <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle"><?php echo e(__("Search From Vimeo API")); ?></h5>
                ...
                <div class="box box-danger">
                    ...
                    <form action="" method="post" name="vimeo-yt-search" id="vimeo-yt-search">
                      <div class="input-group">
                        <input type="search" name="vimeo-search" id="vimeo-search" placeholder="<?php echo e(__('Search')); ?>..." class="form-control" autocomplete="off">
                        <div class="input-group-append">
                          <button class="btn btn-outline-secondary" type="button" id="vimeo-searchBtn"><?php echo e(__('Search')); ?></button>
                        </div>
                      </div>
                    </form>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myyoutubeModalLabel"><?php echo e(__("Search From Youtube API")); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <p><?php echo e(__('Make Sure You Have Added Youtube APIKey In')); ?> <a href="<?php echo e(url('admin/api-settings')); ?>"><?php echo e(__('API Settings')); ?></a></p>
                <?php endif; ?>
                <div class="box box-danger">
                    <div class="box-header">
                        <div class="box-title"><?php echo e(__('Instructions')); ?></div>
                    ...
                    <form action="" method="post" name="hyv-yt-search" id="hyv-yt-search">
                      <div class="input-group">
                        <input type="search" name="hyv-search" id="hyv-search" placeholder="<?php echo e(__('Search')); ?>..." class="form-control" autocomplete="off">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button" id="hyv-searchBtn"><?php echo e(__('Search')); ?></button>
                        </div>
                      </div>
                    </form>
                    <input type="hidden" id="vpageToken" value="">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4">
                <div id="movie_slug" class="form-group text-dark <?php echo e($errors->has('slug') ? ' has-error' : ''); ?>">
                  <?php echo Form::label('slug', __('Movie Slug'),['class' => 'custom-input']); ?><sup class="text-danger">*</sup>
                  ...
                  <div class="col-lg-8">
                    ...
                    <div id="ready_url" style="display: none;" class="form-group text-dark<?php echo e($errors->has('ready_url') ? ' has-error' : ''); ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                          <button type="button" onclick="encript()" id="encryptlink" class="btn btn-sm btn-info float-right"><?php echo e(__('Encrypt Link')); ?></button>
                        </div>
                      </div>
                    ...
                    <div id="uploadvideo" style="display: none;" class="form-group text-dark<?php echo e($errors->has('upload_video') ? ' has-error' : ''); ?> input-file-block">
                        ...
                        <?php else: ?>
                          <small><?php echo e(__("if you haven't added BUNNY key. Set in")); ?> <a href="<?php echo e(url('admin/api-settings')); ?>"><?php echo e(__('API setting')); ?></a> <?php echo e(__('To Upload Videos to BUNNY')); ?></small>
                        <?php endif; ?>
                         <br>
                         <?php if($wasabi==1): ?>
                        ...
                        <?php else: ?>
                          <small><?php echo e(__("if you haven't added WASABI key. Set in")); ?> <a href="<?php echo e(url('admin/api-settings')); ?>"><?php echo e(__('API setting')); ?></a> <?php echo e(__('To Upload Videos to WASABI')); ?></small>
                        <?php endif; ?>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6">
                ...
                <div class="form-group text-dark">
                  ...
                  <small class="badge badge-pill badge-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo e(__('Select those countries where you want to block Movies')); ?>">
                    <i class="fa fa-info"></i>
                  </small>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\NexthourWeb\resources\views/admin/movie/create.blade.php ENDPATH**/ ?>