          ...
          <div class="card-body" id="stepbox">
                <form action="{{ route('store.updateeula') }}" id="step1form" method="POST" class="needs-validation" novalidate>
                  ...
                  <div class="custom-control custom-checkbox">
                      ...
                      <label class="custom-control-label" for="customCheck1"><b>{{ __('I read the terms condition, Privacy Policy carefully and I agree on it.') }}.</b>
                      <b>{{ __('I agree') }} <a href="https://mediacity.co.in/privacy-policy/" title="" target="__blank">{{ __('Privacy Policy') }}</a></b>
                    </label>
                  </div> 
                   @error('eula')
                      <div class="invalid-feedback">
