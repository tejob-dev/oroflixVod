  ...
  <section class="main-wrapper">
    <div class="container-fluid">
      ...
      <div class="watchlist-section">
        <h5 class="section-heading">{{__('Watchlist')}}</h5>
        <div class="watchlist-btn-block">
          <div class="btn-group">
            @php
               ...
               $wishlistItems = App\Wishlist::where('user_id', $auth->id)->pluck('movie_id')->toArray();
               $movies1 = array_filter($wishlistItems);
              $movies_data = App\Movie::whereIn('id', $wishlistItems)->get();
              $tvShows = App\TvSeries::whereIn('id', $wishlistItems)->get();
             }
            ...
            @endphp
              ...
              @foreach ($nav as $menu)
                ...
                <a class="{{ url()->current() === url('account/watchlist', $menu->slug) ? 'active' : '' }}" href="{{url('account/watchlist', $menu->slug)}}"  title="{{$menu->name}}">{{$menu->name}} </a>
   ...
   <script>
    ...
    tabLinks.forEach(function(link, index) {
        link.addEventListener('click', function(event) {
            ...
            // Handle other functionality based on href attribute
            var href = link.getAttribute('href');
            // Add your functionality here based on href
        });
    });
});
