                ...
                <div class="card-body ml-2">
                    ...
                    <div class="bg-info-rgba p-4 mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="mobile"> {{ __('Mobile Number') }}:<sup class="text-danger">*</sup></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{ __('Password') }}<sup class="text-danger">* </sup>
                                        <small class="badge badge-pill badge-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="At least 8 characters long but 14 or more is better. A combination of uppercase letters, lowercase letters, numbers, and symbols is better.">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" class="form-control" rows="1"
                                        placeholder="{{ __('Please Enter Your Address') }}">{{ $user->address }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group text-dark{{ $errors->has('status') ? ' has-error' : '' }}">
                            {!! Form::label('status', __('Verify User')) !!}
                            <!-- Hidden input to set the value of checkbox to 0 if it is unchecked -->
                            <input type="hidden" name="status" value="0">
                            <label class="switch d-block">
                                {!! Form::checkbox('status', 1, $user->status, ['class' => 'custom_toggle']) !!}
