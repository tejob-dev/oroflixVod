	...
	<div class="breadcrumbbar">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">{{ __('Ebook Edit') }}</li>
                    </ol>
                </div>    
    </div>
@endsection
...
<div class="contentbar">   
  ...
  <div class="ebook-create-block">
    ...
    <form action="{{url('admin/ebook/update/'.$ebook->id)}}" class="form" method="POST" novalidate enctype="multipart/form-data">
       @method('PUT')
                     @csrf
    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mb-2">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="category_id" id="exampleFormControlCategory" required>
                                ...
                                <option value="{{$item->id}}" {{$item->id==$ebook->category_id?'selected':''}}>{{$item->name}}</option>
                                @endforeach
                                @endif
                            </select>
                          </div>
