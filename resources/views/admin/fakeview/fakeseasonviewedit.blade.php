    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          ...
          <h5 class="box-title">{{__('Edit Fake TV Series Views')}}</h5>
        </div>
          ...
          {!! Form::model($season, ['method' => 'PATCH', 'action' => ['FakeSeasonViewController@update', $season->id], 'files' => true]) !!}
              <div class="col-md-3">
                <div class="form-group ">
                  ...
                  <sup class="text-danger">*</sup> <small class="badge badge-pill badge-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ __('Add Number of fake views you want to add in particular TV Series.')}}">
