	...
	<ul id="playlists" style="display:none;">
		...
		<li data-source="trailer"
		 data-playlist-name="{{ $liveevent->title }}" data-thumbnail-path="{{asset('images/events/thumbnails/'.$liveevent->thumbnail)}}" >
			<p class="fwduvp-categories-title"><span class="minimialDarkBold">Title: {{ $liveevent->title }}</span></p>
			<p class="fwduvp-categories-description"><span class="minimialDarkBold">Description: </span>{{ $liveevent->detail }}</p>
		</li>
	...
	<ul id="trailer">
		...
		<ul data-ads="">
			...
			<div data-video-short-description="">
				<p class="fwduvp-categories-title"><span class="minimialDarkBold">{{__('Title')}}: </span>{{ $liveevent->title }}</p>
				<p class="fwduvp-categories-description"><span class="minimialDarkBold">{{__('Description')}}: </span>{{ $liveevent->detail }}</p>
			</div>
			<div>
				<p class="fwduvp-thumbnail-title">{{__('title')}}: </span>{{ $liveevent->title }}</p>
				<p class="fwduvp-thumbnail-description">{{__('description')}}: </span>{{ $liveevent->detail }}</p>
			</div>
