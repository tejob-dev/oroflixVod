...
<head>
  ...
  @if($color->color_scheme == 'dark')
    ...
    :root {
      ...
      --background_color: {{$color->custom_text_color != NULL ? $color->custom_text_color : $color->default_text_color}};
              ...
              <ul>
                  ...
                  @if($button->kids_mode==1)
                      ...
                      <li style="width:13%;padding: 0px">
                          <a href="{{route('get.kids', Auth::user()->id)}}"
                              style="background-image: url({{ asset('images/kids.png') }});background-repeat: no-repeat;background-size: contain;margin: 0px 12px;padding: 15px 7px !important;"></a>
                      </li>
                      @endif
                  @endif
              @else
                          ...
                          <div class="admin-wallet-block">
                            <ul>
                              <li><img src="{{url('/images/walletnew.png')}}" class="img-fluid" alt="">
                                <span class="wallet-title">{{__('Wallet Balance')}}</span>
                              </li>
                              <li>
                                <span>
                    ...
                    <div class="row">
                      <!-- <div class="col-sm-6 col-lg-6"> -->
                        <div>
                          <ul class="admin-list">
                            @if($auth->is_admin == 1)
                            <li><a href="{{url('admin')}}" target="_blank"><img src="{{ url('images/user_dropdown/globe.png')}}" class="img-fluid" alt="">{{auth()->user()->getRoleNames()[0]}}
                                {{__('Dashboard')}}</a></li>
                            @endif
                            @if($auth->is_assistant == 1)
                            <li>
                              <a href="{{url('admin')}}" target="_blank"><img src="{{ url('images/user_dropdown/globe.png')}}" class="img-fluid" alt="">
                                {{__('Producer Dashboard')}}</a>
                            </li>
                            @endif
                            <li><a href="{{url('account')}}"><img src="{{ url('images/user_dropdown/pie-chart.png')}}" class="img-fluid" alt="">{{__('Dashboard')}}</a></li>
                            @if(Module::find('Producer') && Module::find('Producer')->isEnabled())
                            @if($auth->is_admin != 1)
                            @if($button->producer_approval==1 && $auth->producer_status == 0)
                            <li><a href="" data-toggle="modal" data-target="#myModalproducer"><img src="{{ url('images/user_dropdown/producer.png')}}" class="img-fluid" alt="">{{__('Become An Producer')}}</a></li>
                            @else
                            <li><a href="{{url('producer/subscription')}}"><img src="{{ url('images/user_dropdown/subscription.png')}}" class="img-fluid" alt="">{{__('Producer Subscription Plans')}}</a></li>
                            @endif
                            @endif
                            @endif
                           @php 
                        ...
                        @if(getSubscription()->getData()->subscribed == true && ($movies->count() > 0 || $seasons->count() > 0 || $audio->count() > 0))
                            <li><a href="{{route('protectedvideo')}}"><img src="{{ url('images/user_dropdown/shield.png')}}" class="img-fluid" alt="">{{__('Protected Content')}}</a></li>

                            @else
                            <li><a href="{{url('account/purchaseplan')}}"><img src="{{ url('images/user_dropdown/subscribe.png')}}" class="img-fluid" alt="">{{__('Subscribe')}}</a></li>
                            @endif 
                            @php 
                             $ebooks = App\Ebook::all();

                            @endphp
                            @if($auth && getSubscription()->getData()->subscribed == true && count($ebooks) > 0)
                            <li><a href="{{url('account/ebook')}}"><img src="{{ url('images/user_dropdown/blog.png')}}" class="img-fluid" alt="">{{__('Ebooks')}}</a></li>
                            @endif
                            @if(auth()->user()->is_admin == 0)
                            <li>
                              <a data-toggle="modal" data-target="#exampleModal">
                                <img src="{{ url('images/user_dropdown/request.png')}}" class="img-fluid" alt="">Delete Account Request
                              </a>
                          </li>
                            ...
                            <li><a href="" data-toggle="modal" data-target="#myModalmovierequest"><img src="{{ url('images/user_dropdown/request.png')}}" class="img-fluid" alt="">{{__('Request a Movie')}}</a></li>
                            @endif
                            @if($auth && getSubscription()->getData()->subscribed == true && $configs->blog==1)
                            <li><a href="{{url('account/blog')}}"><img src="{{ url('images/user_dropdown/blog.png')}}" class="img-fluid" alt="">{{__('Blog')}}</a></li>
                            @endif
                            <li><a href="{{url('faq')}}"><img src="{{ url('images/user_dropdown/help.png')}}" class="img-fluid" alt="">{{__('Faq')}}</a></li>
                            ...
                            <li><a
                                href="{{url('/manageprofile/mus/'.Auth::user()->id)}}"><img src="{{ url('images/user_dropdown/user-profile.png')}}" class="img-fluid" alt="">{{__('Manage Profile')}}</a>
                            </li>
                            @endif
                            @php
                            ...
                            <li><a target="_blank" href="{{$donation_link}}"><img src="{{ url('images/user_dropdown/donation.png')}}" class="img-fluid" alt="">{{__('Donation')}}</a></li>
                            @endif

                            @if(isset($button) && $button->two_factor == 1)
                            <li><a href="{{route('2fa.get')}}"><img src="{{ url('images/user_dropdown/authenticity.png')}}" class="img-fluid" alt="">{{__('2Factor Authentication')}}</a></li>
                            @endif
                            @php
                            ...
                            @endphp
                           @if(isset($watchlist) && count($watchhistory) > 0)

                            <li><a href="{{route('watchhistory')}}"><img src="{{ url('images/user_dropdown/history.png')}}" class="img-fluid" alt="">{{__('Watch History')}} </a> </li>
                            <li><a href="{{route('hidden.videos')}}"><img src="{{ url('images/user_dropdown/hide.png')}}" class="img-fluid" alt="">{{__('Hidden Videos')}} </a> </li>
                            @endif
                            @if(isset($watchlist) && count($watchlist) > 0)
                            <li><a href="{{url('account/watchlist', $nav[0]->slug ?? '')}}"><img src="{{ url('images/user_dropdown/bookmark.png')}}" class="img-fluid" alt="">{{__('Watch list')}} </a> </li>
                            @endif
                            <li>
                              <a href="{{ route('custom.logout') }}"><img src="{{ url('images/user_dropdown/log-out.png')}}" class="img-fluid" alt="">
                                {{__('Sign Out')}}
                              </a>
                            </li>
                          </ul>
  ...
  <div class="small-screen-navigation">
    <nav class="sidenav" id="mySidenav" role="navigation">
        ...
        <ul class="nav sidebar-nav">
            @if($catlog==1)
            @auth
            @if ((isset($menuh) || isset($custom_page)) && Auth::user()->kids_mode_active == 0)
            @if(isset($menuh) && count($menuh) > 0)
            @foreach ($menuh as $menus)
            @if($auth && getSubscription()->getData()->subscribed == true)
            <li>
            ...
            @endforeach
            @endif
            @if($button->kids_mode==1 && Auth::user() && $auth != NULL && getSubscription()->getData()->subscribed == true)
            <li style="width:13%;padding: 0px">
            ...
            @endif
            @else
            <li class="sign-in-block sign-in-block-one sign-in-block-two"><a class="sign-in" href="{{url('login')}}"><i class="flaticon-login"></i> {{__('Sign-in')}}</a></li>
            <li class="sign-in-block sign-in-block-one "><a class="sign-in" href="{{url('register')}}"><i class="flaticon-profile"></i>{{__('Register')}}</a></li>
            @endauth
        </ul>
    </nav>
