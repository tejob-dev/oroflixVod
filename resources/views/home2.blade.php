            ...
            <div class="row">
              <div class="col-md-3 col-sm-5">
                <div class="genre-dtl-block">
                  ...
                  <h5 class="section-heading">{{__('Recently Added')}}</h5>
           ...
           <div class="genre-main-block">
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-5">
                    <div class="genre-dtl-block">
                        <h5 class="section-heading">{{__('Featured')}}</h5>
                         <p class="section-dtl">{{__('at the big screen at home')}}</p>
        ...
        @if(isset($top_data->menu_data))
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-3 col-sm-5">
                <div class="genre-dtl-block">
                  <h5 class="section-heading">{{__('Top Rated')}}</h5>
                </div>
              </div>
              <div class="col-md-9 col-sm-7">
                <div class="genre-main-slider owl-carousel">
           ...
           <div class="genre-main-block">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-3 col-sm-5">
                    <div class="genre-dtl-block">
                        <h5 class="section-heading">{{__('Continue Watching')}} {{-- {{Auth::user()->name}} --}}</h5>
                         <p class="section-dtl">{{__('at the big screen at home')}}</p>
                        @if($auth && getSubscription()->getData()->subscribed == true)
       ...
       <div class="genre-main-block">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-3 col-sm-5">
                <div class="genre-dtl-block">
                    <h5 class="section-heading">{{__('Upcoming Movies')}}</h5>
                     <p class="section-dtl">{{__('at the big screen at home')}}</p>
        ...
        <div class="genre-main-block">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-3 col-sm-5">
                <div class="genre-dtl-block">
                  <h3 class="section-heading">{{__('Recently Added Blogs)}}</h3>
...
<div class="genre-main-block">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3 col-sm-5">
        <div class="genre-dtl-block">
          <h3 class="section-heading">{{__('Live Events')}}</h3>
          <p class="section-dtl">{{__('at the big screen at home')}}</p>
        </div>
      </div>
      <div class="col-md-9 col-sm-7">
