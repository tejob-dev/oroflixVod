  ...
  <div class="container-fluid">        
     <h5 class="section-heading">{{$genre->genre->name }}</h5>
       ...
       @if($auth && getSubscription()->getData()->subscribed == true)
         ...
         <a href="{{ route('show.in.genre',$genre->genre_id) }}" class="see-more"> <b>{{__('View All')}}</b></a>
     
       @else
       
         <a href="{{ route('show.in.guest.genre',$genre->genre_id) }}" class="see-more"> <b>{{__('View All')}}</b></a>
