        ...
        <div class="container__child signup__form">
          <form method="POST" action="{{ route('password.request') }}">
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
              ...
              <input id="email" type="text" class="form-control" name="email" placeholder="{{__('Enter Your Email')}}" value="{{ $email or old('email') }}" required autofocus>
              @if ($errors->has('email'))
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
              ...
              <input id="password" type="password" class="form-control" name="password" placeholder="{{__('Enter Your New Password')}}" required>
            ...
            <div class="form-group">
              ...
              <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="{{__('Enter Your Passowrd Again')}}" required>
            </div>
            <div class="m-t-lg">
              <input class="btn btn--form btn--form-login" type="submit" value="{{__('Reset Password')}}" />
            </div>
          </form>
        </div>
      </div>
