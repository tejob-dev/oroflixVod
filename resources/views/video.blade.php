...
@foreach($movies as $movie)
    ...
    <ul id="playlists" style="display:none;">
			...
			<li data-source="list=PLxKHVMqMZqUQFbRO0VWaHMaWuQagIgpJe"  data-playlist-name="MY YOUTUBE PLAYLIST 1" data-thumbnail-path="content/thumbnails/large2.jpg">
				<p class="fwduvp-categories-title"><span class="fwduvp-header">Title: </span>My Youtube playlist 1</p>
			...
			<li data-source="mixedPlaylist" data-playlist-name="MY MIXED PLAYLIST 1" data-thumbnail-path="content/thumbnails/large3.jpg">
				<p class="fwduvp-categories-title"><span class="fwduvp-header">Title: </span>My mixed playlist 1</p>
				<p class="fwduvp-categories-type"><span class="fwduvp-header">Type: </span>MIXED</p>
				<p class="fwduvp-categories-description"><span class="fwduvp-header">Description: </span>Created using HTML elements, videos are loaded and played from the server or Youtube.</p>
			</li>
			...
			<li data-source="http://www.webdesign-flash.ro/p/uvp/content/playlist_dark.xml" data-playlist-name="MY XML PLAYLIST 1" data-thumbnail-path="content/thumbnails/large4.jpg">
				<p class="fwduvp-categories-title"><span class="fwduvp-header">Title: </span>My XML playlist 1</p>
				<p class="fwduvp-categories-type"><span class="fwduvp-header">Type: </span>XML</p>
				<p class="fwduvp-categories-description"><span class="fwduvp-header">Description: </span>Created using a XML file, videos are loaded and played from the server or Youtube.</p>
			</li>

			<li data-source="vimeoPlaylist" data-playlist-name="VIMEO PLAYLIST" data-thumbnail-path="content/thumbnails/large19.jpg">
				<p class="fwduvp-categories-title"><span class="fwduvp-header">Title: </span>MY VIMEO PLAYLIST 1</p>
				<p class="fwduvp-categories-type"><span class="fwduvp-header">Type: </span>VIMEO</p>
				<p class="fwduvp-categories-description"><span class="fwduvp-header">Description: </span>Created using HTML elements, videos are loaded and played from Vimeo.</p>
			</li>

			<li data-source="folder=videos" data-playlist-name="MY FOLDER PLAYLIST 1" data-thumbnail-path="content/thumbnails/large5.jpg">
				<p class="fwduvp-categories-title"><span class="fwduvp-header">Title: </span>My folder playlist 1</p>
				<p class="fwduvp-categories-type"><span class="fwduvp-header">Type: </span>FOLDER</p>
				<p class="fwduvp-categories-description"><span class="fwduvp-header">Description: </span>Created using a folder with mp4 files, videos are loaded and played from the server.</p>
			</li>

			<li data-source="playlist1" data-playlist-name="MY HTML PLAYLIST 2" data-thumbnail-path="content/thumbnails/large6.jpg">
				<p class="fwduvp-categories-title"><span class="fwduvp-header">Title: </span>My HTML playlist 2</p>
				<p class="fwduvp-categories-type"><span class="fwduvp-header">Type: </span>HTML</p>
				<p class="fwduvp-categories-description"><span class="fwduvp-header">Description: </span>Created using html elements, videos are loaded and played from the server.</p>
			</li>
		...
		<ul id="playlist1" style="display:none;">
				...
				<li data-thumb-source="content/thumbnails/small-fwd.jpg" data-video-source="{{ $movie->trailer_url }}" data-start-at-subtitle="2" data-downloadable="yes">	<div data-video-short-description="">
						<div>
							...
							<p class="fwduvp-thumbnail-description">Each video can contain a short description, the description can be formatted with CSS as you like.</p>
						</div>
					</div>
					<div data-video-long-description="">
						<div>
							<p class="fwduvp-video-title">VIDEO TITLE</p>
							...
							<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/" target="_blank">this link</a></p>
						</div>
					</div>
				</li>
				...
				<ul data-ads="">
					...
					<div data-video-short-description="">
						<div>
							<p class="fwduvp-thumbnail-title">HORIZONTAL GRIDFOLIO PRO</p>
							<p class="fwduvp-thumbnail-description">Fully responsive media grid plugin with HTML content support.</p>
						</div>
					</div>
					<div data-video-long-description="">
						<div>
							<p class="fwduvp-video-title">HORIZONTAL GRIDFOLIO PRO</p>
							<p class="fwduvp-video-main-description">Each video can contain a detailed description, the description can be formatted with CSS as you like. The description window and description button can be disabled individually for each video or globally for all videos.</p>
							<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/p/horizontal-gridfolio-pro/" target="_blank">this link</a></p>
						</div>
					</div>
				</li>
				...
				<div data-video-short-description="">
					<div>
						<p class="fwduvp-thumbnail-title">ROYAL AUDIO PLAYER</p>
						<p class="fwduvp-thumbnail-description">HTML5 mp3 player for your website that runs on all major browsers and mobile devices.</p>
					</div>
				</div>
				<div data-video-long-description="">
					<div>
						<p class="fwduvp-video-title">ROYAL AUDIO PLAYER</p>
						<p class="fwduvp-video-main-description">Each video can contain a detailed description, the description can be formatted with CSS as you like. The description window and description button can be disabled individually for each video or globally for all videos.</p>
						<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/p/rap/" target="_blank">this link</a></p>
					</div>
				</div>
				<ul data-annotations="">
						...
						<li data-start-time="00:00:03" data-end-time="00:00:29" data-left="10" data-top="222" data-show-close-button="yes" data-click-source="alert('This is a javascript function called using the annotations feature of Ultimate Video Player!');" data-click-source-target="_blank" data-normal-state-class="UVPAnnotationJavascriptNormal" data-selected-state-class="UVPAnnotationJavascriptSelected">
							<div><span style="font-weight:bold; text-decoration: underline;">JAVASCRIPT</span> support, a javascript function can be called on click.</div>
						</li>
			...
			<li data-thumb-source="content/thumbnails/small-r3dcov.jpg" data-video-source="content/videos/grid.mp4" data-poster-source="content/posters/mp4-poster.jpg,content/posters/mp4-poster-mobile.jpg" data-downloadable="yes">
				<div data-video-short-description="">
					<div>
						<p class="fwduvp-thumbnail-title">ROYAL 3D COVERFLOW</p>
						<p class="fwduvp-thumbnail-description">Fully responsive 3D Coverflow that allows to display media or HTML content with an unique layout.</p>
					</div>
				</div>
				<div data-video-long-description="">
					<div>
			...
			<li data-thumb-source="content/thumbnails/small-msp.jpg" data-video-source="content/videos2/fwd-1080p.mp4" data-poster-source="content/posters/mp4-poster.jpg,content/posters/mp4-poster-mobile.jpg" data-is-private="yes" data-private-video-password="428c841430ea18a70f7b06525d4b748a">
				<div data-video-short-description="">
					<div>
						...
						<p class="fwduvp-thumbnail-description">Support for private videos.</p>
					</div>
				</div>
				<div data-video-long-description="">
					<div>
						<p class="fwduvp-video-title">MP3 STICKY PLAYER</p>
						<p class="fwduvp-video-main-description">Each video can contain a detailed description, the description can be formatted with CSS as you like. The description window and description button can be disabled individually for each video or globally for all videos.</p>
						<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/p/msp/" target="_blank">this link</a></p>
					</div>
				</div>
			</li>
			...
			<li data-thumb-source="content/thumbnails/small-rap.jpg" data-video-source="content/videos2/fwd-1080p.mp4" data-poster-source="content/posters/mp4-poster.jpg,content/posters/mp4-poster-mobile.jpg" data-start-at-time="00:00:10" data-stop-at-time="00:00:40">
				<div data-video-short-description="">
					<div>
						...
						<p class="fwduvp-thumbnail-description">UVP can be set to start or / and stop at a specified time.</p>
					</div>
				</div>
				<div data-video-long-description="">
					<div>
			...
			<li data-thumb-source="content/thumbnails/small-rap.jpg" data-video-source="content/videos2/fwd-1080p.mp4" data-poster-source="content/posters/mp4-poster.jpg,content/posters/mp4-poster-mobile.jpg" data-advertisement-on-pause-source="http://www.webdesign-flash.ro/iframe.html">
				<div data-video-short-description="">
					<div>
						...
						<p class="fwduvp-thumbnail-description">The source can be any webpage.</p>
					</div>
				</div>
			...
			<li data-thumb-source="content/thumbnails/small-s3dcov.jpg" data-video-source="content/videos2/fwd-1080p.mp4" data-poster-source="content/posters/mp4-poster.jpg,content/posters/mp4-poster-mobile.jpg" data-downloadable="no" data-vast-url="content/vast-pod.xml" data-vast-clicktrough-target="_blank" data-vast-linear-astart-at-time="00:00:00">
				<div data-video-short-description="">
					<div>
						<p class="fwduvp-thumbnail-title">VAST XML EXAMPLE</p>
						<p class="fwduvp-thumbnail-description">Support for VAST <span style='color:#FFFFFF'> "Video Ad Serving Template"</span> pre-roll, mid-roll, post roll with unique functionality.</p>
					</div>
				</div>
				<div data-video-long-description="">
					<div>
						<p class="fwduvp-thumbnail-title">VAST XML EXAMPLE</p>
						<p class="fwduvp-video-main-description">Each video can contain a detailed description, the description can be formatted with CSS as you like. The description window and description button can be disabled individually for each video or globally for all videos.</p>
						<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/p/s3dcov/" target="_blank">this link</a></p>
					</div>
				</div>
			</li>
		...
		<ul id="mixedPlaylist" style="display:none;">
				...
				<li data-thumb-source="content/thumbnails/small-lora.jpg" data-video-source="https://www.youtube.com/watch?v=oIHyVibVwVA" data-poster-source="content/posters/youtube-poster.jpg,content/posters/youtube-poster-mobile.jpg" data-downloadable="no">
					<div data-video-short-description="">
						<div>
							<p class="fwduvp-thumbnail-title">LORA PUISOR</p>
							<p class="fwduvp-thumbnail-description">Each video can contain a short description, the description can be formatted with CSS as you like.</p>
						</div>
					</div>
					<div data-video-long-description="">
						<div>
							<p class="fwduvp-video-title">LORA - PUISOR</p>
							<p class="fwduvp-video-main-description">Each video can contain a detailed description, the description can be formatted with CSS as you like. The description window and description button can be disabled individually for each video or globally for all videos.</p>
							<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/" target="_blank">this link</a></p>
						</div>
					</div>
				...
				<li data-thumb-source="content/thumbnails/v1.jpg" data-video-source="https://vimeo.com/channels/top/62092214" data-poster-source="content/posters/vimeo-poster.jpg,content/posters/vimeo-poster-mobile.jpg">
					<div data-video-short-description="">
						<div>
							<p class="fwduvp-thumbnail-title">BITING ELBOWS</p>
							<p class="fwduvp-thumbnail-description">Support 'Hardcore' - the spiritual sequel to Bad Motherfucker on Indiegogo.</p>
						</div>
					</div>
					<div data-video-long-description="">
						<div>
							<p class="fwduvp-video-title">BITING ELBOWS</p>
							<p class="fwduvp-video-main-description">Each video can contain a detailed description, the description can be formatted with CSS as you like. The description window and description button can be disabled individually for each video or globally for all videos.</p>
							<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/" target="_blank">this link</a></p>
						</div>
					</div>
		...
		<ul id="vimeoPlaylist" style="display:none;">
				...
				<li data-thumb-source="content/thumbnails/v2.jpg" data-video-source="https://vimeo.com/channels/top/22439234" data-poster-source="content/posters/vimeo-poster.jpg,content/posters/vimeo-poster-mobile.jpg">
					<div data-video-short-description="">
						<div>
							<p class="fwduvp-thumbnail-title">THE MOUNTAIN</p>
							<p class="fwduvp-thumbnail-description">This was filmed between 4th and 11th April 2011. I had the pleasure of visiting El Teide.</p>
						</div>
					</div>
					<div data-video-long-description="">
						<div>
							<p class="fwduvp-video-title">THE MOUNTAIN</p>
							<p class="fwduvp-video-main-description">Each video can contain a detailed description, the description can be formatted with CSS as you like. The description window and description button can be disabled individually for each video or globally for all videos.</p>
							<p class="fwduvp-link">For more information about this please follow <a href="http://www.webdesign-flash.ro/" target="_blank">this link</a></p>
						</div>
					</div>
