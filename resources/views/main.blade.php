          ...
          <div class="panel-setting-main-block panel-subscribe">
            <div class="container-fluid">
              <div class="plan-block-dtl">
                <h3 class="plan-dtl-heading text-center">{{__('Purchase any of the membership package from below.')}}</h3>
                <div class="plan-dtl-list">
                  
                  <ul>
                    <li>{{__('Select in of your preferred membership package & make payment.')}}
                    </li>
