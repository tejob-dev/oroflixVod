                    ...
                    @if($slide->active == 1)
                        <div class="slider-block">
                            <div class="slider-image">
                                @php
                                $authLink = $auth ? 'movie/detail' : 'movie/guest/detail';
                                $authParam = $auth ? '' : '/guest';
                                $movieLink = url($authLink, $slide->movie->id);
                                $imageSrc = $slide->slide_image ? asset('images/home_slider/movies/'.$slide->slide_image) : asset('images/movies/posters/'.$slide->movie->poster);
                                @endphp
                                <a href="{{ $movieLink }}">
                                    <img src="{{ $imageSrc }}" class="img-responsive" alt="slider-image">
                                </a>
                            </div>
                        </div>
                    @endif
    ...
    <div id="ageWarningModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 style="color: #c0392b">{{__('Warning For Age Restrict Text')}}</h5>
                </div>
            </div>
        </div>
    </div>
