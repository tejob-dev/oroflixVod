...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('permissions')->insert(array (
            ...
            array (
                'id' => 147,
                'name' => 'packageforproducer.create',
                'guard_name' => 'web',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
            ...
            array (
                'id' => 149,
                'name' => 'packageforproducer.delete',
                'guard_name' => 'web',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
